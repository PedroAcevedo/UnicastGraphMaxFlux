...
% BUSCAR LOS GRAFOS QUE SEAN IGUALES AL MINIMO FLUJO Y ASIGNARLOS PRIMERO
% AL GRAFO GENERAL. ASIGNAR LOS FLUJOS MÁS CORTOS DE LOS QUE SOBREPASAN EL
% FLUJO MAXIMO Y LUEGO EL SIGUIENTE MÁS CORTO, SI ES UNA RUTA NUEVA NO
% ASIGNADA (NO TIENE CEROS EN LA MATRIZ DE GRAFO GENERAL) Y SI NO ES NUEVA
% QUE COINCIDA JUNTO CON EL MÁS CORTO EN OTRAS RUTAS YA ASIGNADAS.
